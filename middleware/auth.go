...
func TokenAuth() func(c *gin.Context) {
	return func(c *gin.Context) {
		AlphaAuthCrypto := c.Request.Header.Get("AlphaAuthCrypto")
		if AlphaAuthCrypto != "" {
...
type authAlphaUserInfo struct {
	Username string `json:"user_name"`
	UserId   string `json:"user_id"`
}

func ParserAlphaUserToken(tokenString string) (*authAlphaUserInfo, error) {
